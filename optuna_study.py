...
def objective(trial):
  ...
  args.hard_neg_sampling_threshold = trial.suggest_uniform("hard_neg_sampling_threshold", 0, 0.9)
  args.random_seed = trial.suggest_categorical(name="random seed", choices=[9997237, 5644829, 7777967, 7, 2])
