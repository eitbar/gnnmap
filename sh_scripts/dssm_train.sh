CUDA_VISIBLE_DEVICES=1 python dssm_train.py --train_dict "./data/en-zh/en-zh.0-5000.txt" \
                                            ...
                                            --out_src "./data/en-zh/en.whitening.a.hardp.vec" \
                                            --out_tar "./data/en-zh/zh.whitening.a.hardp.vec" \
                                            --model_filename "./data/en-zh/ENZH-model.a.hardp.pickle" \
