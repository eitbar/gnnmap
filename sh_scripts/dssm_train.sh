CUDA_VISIBLE_DEVICES=2 python dssm_train.py --train_dict "./data/en-zh/en-zh.0-5000.txt" \
                                            ...
                                            --out_src "./data/en-zh/en.whitening.bi_samplewise_desort.vec" \
                                            --out_tar "./data/en-zh/zh.whitening.bi_samplewise_desort.vec" \
                                            --model_filename "./data/en-zh/ENZH-model.bi_samplewise_desort.pickle" \
